...
@Component
public class GetUserAccessTokenInfoByEmailAndEventMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			List<UserAccessTokenInfo> resultTmp = userServices.getUserAccessTokenInfoByEvent(userEmail, customerId, applicationId);
			Response res = new Response();
			res.setReturnCode(ServiceReturnMessages.SUCCESS_CODE);
			res.setReturnMessage(ServiceReturnMessages.SUCCESS);
			HashMap<String, Object> result = new HashMap<>();
			result.put("userAccessTokenInfo", resultTmp);
