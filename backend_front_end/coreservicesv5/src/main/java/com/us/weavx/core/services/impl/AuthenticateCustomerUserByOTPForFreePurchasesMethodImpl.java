...
@Component
public class AuthenticateCustomerUserByOTPForFreePurchasesMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			//Spring context
			AuthenticatedUserInfo userInfo = userServices.authenticateCustomerUserByOTPFree(otpId, otpCode, ipAddress, userAgent);
