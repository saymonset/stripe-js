...
@Component
public class FindEventAssetsByLangMethodImpl implements ServiceMethod {
	...
	public Response executeMethod(Request request) {
		try {
			...
			List<EventAsset> eventAssets = txServices.findEventAssetsByEventAndLang(customerId, applicationId, langId);
