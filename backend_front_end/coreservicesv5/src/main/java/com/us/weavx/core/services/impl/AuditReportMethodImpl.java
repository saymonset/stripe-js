...
@Component
public class AuditReportMethodImpl implements ServiceMethod {
	@Autowired
	private AuditTxServices services;
	...
	public Response executeMethod(Request request) {
		try {
			...
			Integer auditLevelId = ((Number) params.get("audit_level_id")).intValue();
			...
			List<Map<String, Object>> reportRecords = services.findAuditRecords(filtersParamList, customerId, auditLevelId);
			Response res = new Response();
			res.setReturnCode(ServiceReturnMessages.SUCCESS_CODE);
			res.setReturnMessage(ServiceReturnMessages.SUCCESS);
			HashMap<String, Object> result = new HashMap<String, Object>();
			result.put("auditRecords", reportRecords);
