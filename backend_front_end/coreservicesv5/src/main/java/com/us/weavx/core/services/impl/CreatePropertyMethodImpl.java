...
@Component
public class CreatePropertyMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			int	propertyId  = (Integer) params.get("propertyId");
			long customerId = aInfo.getCustomerId();
			Property prop = new Property(propertyId,propertyName);
			//Se inicializa el container de spring
			prop = services.createProperty(prop);
