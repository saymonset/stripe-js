...
@Component
public class GetCustomerGendersDescriptionMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			List<GenderDescription> resultTmp = configurationServices.getCustomerGendersDescription(customerId);
			Response res = new Response();
			res.setReturnCode(ServiceReturnMessages.SUCCESS_CODE);
			res.setReturnMessage(ServiceReturnMessages.SUCCESS);
			HashMap<String, Object> result = new HashMap<>();
			result.put("genderDescriptions", resultTmp);
