...
@Component
public class AddCustomerUserCreditCardByPaymentGatewayMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			CustomerUserCreditCard newCard = txServices.addCustomerUserCreditCardInPaymentGateway(uAT.getCustomerUserId(), customerId, paymentGwId, parameters);
			Response res = new Response();
			HashMap<String, Object> result = new HashMap<>();
			result.put("newCard", newCard);
