...
@Component
public class CreditCardPurchaseMethodImpl implements ServiceMethod {
	...
	public Response executeMethod(Request request) {
		try {
			...
			PaymentResult paymentResult = transactionServices.proccessCreditCardTransaction(transaction, transactionDetails, pGwInfo, txUserData, userToken, langId, couponSerial, userAgent, ipAddress);
			Response res = new Response();
