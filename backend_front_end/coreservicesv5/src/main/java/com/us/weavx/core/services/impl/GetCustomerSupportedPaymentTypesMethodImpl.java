...
@Component
public class GetCustomerSupportedPaymentTypesMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			List<CustomerSupportedPaymentType> custSupPT = services.getCustomerSupportedPaymentTypes(customerId);
			Response res = new Response();
			res.setReturnCode(ServiceReturnMessages.SUCCESS_CODE);
			res.setReturnMessage(ServiceReturnMessages.SUCCESS);
			HashMap<String, Object> result = new HashMap<>();
			result.put("customerSupportedPaymentTypes", custSupPT);
