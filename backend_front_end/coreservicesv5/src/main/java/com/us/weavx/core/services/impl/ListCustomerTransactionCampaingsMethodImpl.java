...
@Component
public class ListCustomerTransactionCampaingsMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			List<TransactionCampaing> transactionCampaings = services.listCustomerTransactionCampaings(customerId);
			Response res = new Response();
			res.setReturnCode(ServiceReturnMessages.SUCCESS_CODE);
			res.setReturnMessage(ServiceReturnMessages.SUCCESS);
			HashMap<String, Object> result = new HashMap<>();
			result.put("transactionCampaings", transactionCampaings);
