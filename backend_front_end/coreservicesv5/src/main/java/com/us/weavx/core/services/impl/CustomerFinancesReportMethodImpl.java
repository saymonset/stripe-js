...
@Component
public class CustomerFinancesReportMethodImpl implements ServiceMethod {
	...
	public Response executeMethod(Request request) {
		try {
			...
			List<Map<String, Object>> reportRecords = services.getFinancesReport(filtersParamList, customerId);
