...
@Component
public class CustomerTransactionReportMethodImpl implements ServiceMethod {
	...
	public Response executeMethod(Request request) {
		try {
			...
			List<Map<String, Object>> reportRecords = services.getCustomerTransactionReport(filtersParamList, customerId);
