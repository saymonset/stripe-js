...
@Component
public class RemoveCustomerUserCreditCardByPaymentGatewayMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			txServices.removeCustomerUserCreditCardInPaymentGateway(uAT.getCustomerUserId(), customerId, paymentGwId, parameters);
