...
@Component
public class UpdateEventCommissionSettingsMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			eventCommissionSettings.setId(((Number) eventCommissionSettingsParam.get("id")).longValue());
			...
			txServices.updateEventCommissionSettings(eventCommissionSettings);
