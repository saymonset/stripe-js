...
@Component
public class GetCustomerIdentityProvidersInfoMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			//Context
			List<CustomerIdentityProvider> resultTmp = configurationServices.getCustomerIdentityProviders(customerId);
			Response res = new Response();
			res.setReturnCode(ServiceReturnMessages.SUCCESS_CODE);
			res.setReturnMessage(ServiceReturnMessages.SUCCESS);
			HashMap<String, Object> result = new HashMap<>();
			result.put("customer_identity_providers", resultTmp);
