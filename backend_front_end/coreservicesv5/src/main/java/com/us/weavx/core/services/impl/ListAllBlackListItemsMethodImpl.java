...
@Component
public class ListAllBlackListItemsMethodImpl implements ServiceMethod {
	@Autowired
	private BlackListTxServices blackListServices;

	public Response executeMethod(Request request) {
		try {
			List<BlackListItem> resultTmp = blackListServices.listAllBlackListItems();
			Response res = new Response();
			res.setReturnCode(ServiceReturnMessages.SUCCESS_CODE);
			res.setReturnMessage(ServiceReturnMessages.SUCCESS);
			HashMap<String, Object> result = new HashMap<>();
			result.put("blackListItems", resultTmp);
