...
@Component
public class GetCustomerSystemMessagesMethodImpl implements ServiceMethod {
	@Autowired
	...
	public Response executeMethod(Request request) {
		try {
			...
			List<CustomerSystemMessage> resultTmp = configurationTxServices.getCustomerSystemMessages(customerId);
			Response res = new Response();
			res.setReturnCode(ServiceReturnMessages.SUCCESS_CODE);
			res.setReturnMessage(ServiceReturnMessages.SUCCESS);
			HashMap<String, Object> result = new HashMap<>();
			result.put("customerSystemMessages", resultTmp);
